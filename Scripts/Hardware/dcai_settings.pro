...
;\\ Settings file written (UT): 2013-03-28
pro dcai_settings, settings = settings
	...
	settings.etalon[0].steps_per_order = 17.0858
	settings.etalon[0].scan_voltage = 43000
	settings.etalon[0].reference_voltage = 42500
	settings.etalon[0].parallel_offset = [0, 3065, 5626]
	...
	settings.etalon[1].steps_per_order = 16.6164
	settings.etalon[1].scan_voltage = 10080
	settings.etalon[1].reference_voltage = 10080
	settings.etalon[1].parallel_offset = [0, -118, 3493]
